...
// This object holds the content for the Psychological Counselling section.
...
import psych from "../assets/psychological.jpg";
  ...
  return (
    <div className="bg-gradient-to-br from-purple-100 to-white">
      ...
      <div className="min-h-screen w-full bg-gradient-to-br from-purple-100 to-white px-4 py-8">
        {/* The `...psychologicalCounsellingContent` passes all properties of the object as individual props to the child component. */}
