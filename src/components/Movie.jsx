...
import movie0 from "../assets/movie/movie0.jpg";
...
const Movie = () => {
  ...
  return (
    <div className="mb-16">
      ...
      >
        Movie outings provide a fun and engaging way to enjoy stories together,
        experience different worlds, and bond through shared laughter and emotions.
      </motion.p>
