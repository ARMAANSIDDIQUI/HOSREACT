...
// This array defines a list of services, each with an icon, a label, and a path for navigation.
const services = [
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            {/* The `Link` component provides client-side navigation within the application without a full page reload.
                It also enables navigation to specific sections of a page using a hash (`#`). */}
          ...
          <div className="md:col-span-2">
            ...
            {/* The `map` function iterates over the `services` array to dynamically create a list of links. */}
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-3">
              <a
                ...
                target="_blank"
                // The `rel="noopener noreferrer"` attribute is a security measure to prevent a potential `window.opener` vulnerability when linking to new tabs.
